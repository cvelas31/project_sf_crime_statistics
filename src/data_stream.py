...
def run_spark_job(spark):
    ...
    df = spark \
        ...
        .option("subscribe", "police.sf.service.calls") \
    ...
    agg_df = distinct_table\
        .select(F.col("original_crime_type_name"), F.col("call_date_time"), F.col("disposition"))\
        .withWatermark("call_date_time", "60 minutes")\
        .groupBy(F.window(distinct_table.call_date_time, "10 minutes", "5 minutes"),
                 F.col("original_crime_type_name")).count()
